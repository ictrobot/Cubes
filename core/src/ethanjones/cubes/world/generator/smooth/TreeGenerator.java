...
public class TreeGenerator {
  ...
  public void generateTree(int x, int y, int z, int h, Area area) {
    ...
    setBlock(area, Blocks.leaves, x - 1, y + h, z - 2, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h, z - 2, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h, z - 2, 1);
    //setBlock(area, Blocks.leaves, x + 2, y + h, z - 2);
  
    setBlock(area, Blocks.leaves, x - 2, y + h, z - 1, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h, z - 1, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h, z - 1, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h, z - 1, 1);
    setBlock(area, Blocks.leaves, x + 2, y + h, z - 1, 1);
  
    setBlock(area, Blocks.leaves, x - 2, y + h, z + 0, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 2, y + h, z + 0, 1);
    ...
    setBlock(area, Blocks.leaves, x - 2, y + h + 1, z + 0, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h + 1, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h + 1, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 2, y + h + 1, z + 0, 1);
  
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z - 2, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z - 1, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z + 0, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z + 1, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 1, z + 2, 1);
  
    setBlock(area, Blocks.leaves, x + 1, y + h + 1, z + 1, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h + 1, z - 1, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h + 1, z + 1, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h + 1, z - 1, 1);
    ...
    setBlock(area, Blocks.leaves, x + 0, y + h + 2, z + 1, 1);
    setBlock(area, Blocks.leaves, x + 0, y + h + 2, z - 1, 1);
    setBlock(area, Blocks.leaves, x + 1, y + h + 2, z + 0, 1);
    setBlock(area, Blocks.leaves, x - 1, y + h + 2, z + 0, 1);
