...
public class CameraController extends InputAdapter {
  ...
  public boolean touchDown(int screenX, int screenY, int pointer, int button) {
    Cubes.getClient().renderer.hudRenderer.touch(screenX, screenY, pointer, button);
  ...
  public boolean mouseMoved(int screenX, int screenY) {
    if (Cubes.getClient().renderer.hudRenderer.noCursorCatching()) return false;
  ...
  public void update() {
    if (Cubes.getClient().renderer.hudRenderer.noCursorCatching()) return;
    if (touchpad != null) {
